...
class QualityPoint(models.Model):
    ...
    def action_see_quality_checks(self):
        self.ensure_one()
        action = self.env["ir.actions.actions"]._for_xml_id("quality_ctrl_community.quality_check_action_main")
    ...
    def action_see_spc_control(self):
        self.ensure_one()
        action = self.env["ir.actions.actions"]._for_xml_id("quality_ctrl_community.quality_check_action_spc")
...
class QualityCheck(models.Model):
    ...
    def correct_measure(self):
        ...
        return {
            ...
            'view_mode': 'form',
            'view_id': self.env.ref('quality_ctrl_community.quality_check_view_form_small').id,
            'target': 'new',
            'res_id': self.id,
    ...
    def do_alert(self):
        ...
        return {
            ...
            'views': [(self.env.ref('quality_ctrl_community.quality_alert_view_form').id, 'form')],
            'res_id': alert.id,
    ...
    def action_see_alerts(self):
        ...
        if len(self.alert_ids) == 1:
            ...
            action = self.env["ir.actions.actions"]._for_xml_id("quality_ctrl_community.quality_alert_action_check")
    ...
    def action_open_quality_check_wizard(self, current_check_id=None):
        ...
        action = self.env["ir.actions.actions"]._for_xml_id("quality_ctrl_community.action_quality_check_wizard")
...
class ProductTemplate(models.Model):
    ...
    quality_control_point_qty = fields.Integer(compute='_compute_quality_check_qty', groups='quality_community.group_quality_user')
    quality_pass_qty = fields.Integer(compute='_compute_quality_check_qty', groups='quality_community.group_quality_user')
    quality_fail_qty = fields.Integer(compute='_compute_quality_check_qty', groups='quality_community.group_quality_user')
    ...
    def action_see_quality_control_points(self):
        self.ensure_one()
        action = self.env["ir.actions.actions"]._for_xml_id("quality_ctrl_community.quality_point_action")
