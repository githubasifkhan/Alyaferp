...
class n2n_stock_move_analysis_wizard(models.TransientModel):
	...
	nn_type = fields.Selection([('Production', 'Production'),('Sales', 'Sales'),('Sales Return', 'Sales Return'),('Purchase', 'Purchase'),('Purchase Return', 'Purchase Return'),('Inventory Adjustment','Inventory Adjustment'),('Internal Transfer','Internal Transfer')],"Operation Type")
	...
	def generate(self):
		...
		action = self.env.ref('AG_stock_report.action_n2n_stock_move_analysis_new').sudo()
